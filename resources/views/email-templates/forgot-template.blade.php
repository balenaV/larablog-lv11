                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05); border: 1px solid #e1e8ed;">
                    ...
                    <tr>
                        <td style="padding: 50px 40px; text-align: center;">
                            ...
                            <h3 style="color: #555555; font-weight: 400; font-size: 18px;">Esqueceu sua senha?</h3>

                            <p style="color: #718096; font-size: 16px; line-height: 1.6; margin: 25px 0;">
                                Recebemos uma solicitação para redefinir a senha da sua conta.<br>
                                Basta clicar no botão abaixo para escolher uma nova.
                            </p>

                            <table border="0" cellpadding="0" cellspacing="0" style="margin: 35px auto;">
                                <tr>
                                    <td align="center" bgcolor="#0d6efd" style="border-radius: 6px;">
                                        <a href="{{ $actionlink }}" target="_blank" style="display: inline-block; padding: 14px 35px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px;">
                                            Redefinir Senha
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="color: #a0aec0; font-size: 13px; line-height: 1.5; margin-top: 40px; border-top: 1px solid #edf2f7; padding-top: 20px;">
                                Se você não solicitou isso, pode ignorar este e-mail com segurança.<br>
                                O link expirará automaticamente em breve.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f8fafc; padding: 30px; text-align: center; border-top: 1px solid #edf2f7;">
                            ...
                            <p style="margin: 5px 0 0 0; color: #cbd5e1; font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px;">
